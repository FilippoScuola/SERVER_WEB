...
def carica_dati():
    ...
    return host,porta   #restituisce i valori di 'host' e 'porta'

def main():
    
    HOST, PORT = carica_dati() #carica nella variabile globale 'HOST' e 'PORT' i valori restituiti dalla funzione 'carica_dati()'
